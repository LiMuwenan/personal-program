...
public class CommonResult<T> {
    ...
    public static <T> CommonResult<T> failed() {
        return new CommonResult<T>(HttpCodeEnum.HTTP_FAILED.getCode(), HttpCodeEnum.HTTP_SUCCESS.getMessage());
    }

    public static <T> CommonResult<T> failed(String message) {
        return new CommonResult<T>(HttpCodeEnum.HTTP_FAILED.getCode(), message);
    }

    public static <T> CommonResult<T> failed(String message, T data) {
        return new CommonResult<T>(HttpCodeEnum.HTTP_FAILED.getCode(), message, data);
    }

    public static <T> CommonResult<T> failed(T data) {
        return new CommonResult<T>(HttpCodeEnum.HTTP_FAILED.getCode(), HttpCodeEnum.HTTP_FAILED.getMessage(), data);
    }
